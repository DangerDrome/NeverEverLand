...
// Create all default voxel assets
async function generateAssets() {
    const writer = new VoxWriter();
    const basePath = path.join(__dirname, '../../public/assets');
    
    console.log('Generating voxel assets...\n');
    
    // GRASS ASSETS
    console.log('Creating grass assets...');
    ...
    console.log('  ✓ flower.vox');
    
    // STONE ASSETS
    console.log('\nCreating stone assets...');
    ...
    console.log('  ✓ pillar.vox');
    
    // WOOD ASSETS
    console.log('\nCreating wood assets...');
    ...
    console.log('  ✓ fence.vox');
    
    // LEAVES ASSETS
    console.log('\nCreating leaves assets...');
    ...
    console.log('  ✓ topiary.vox');
    
    console.log('\n✅ All assets generated successfully!');
    console.log(`📁 Assets saved to: ${basePath}`);
}
